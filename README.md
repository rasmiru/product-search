# Product Search React JS

Welcome to the Product Search React JS project! This web application allows you to search, browse and filter various products.
...
1. Clone this repository to your local machine:
   ...
   ```bash
   git clone https://github.com/rasmiru/product-search.git
   ```
